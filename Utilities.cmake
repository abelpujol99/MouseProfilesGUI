...
function(GetSourceDir out_dir sub_dir_path)
    set(${out_dir} ${CMAKE_CURRENT_SOURCE_DIR}/${sub_dir_path} PARENT_SCOPE)
endfunction()

function(GetProjectName project_dir out_project_name)
    cmake_path(GET project_dir FILENAME ProjectId)
...
function(GetCodeFiles project_dir source_dir out_code_files)
    GetGlobalExpression(${project_dir}/${source_dir} GLOBAL_EXPRESSION)
    ...
    foreach (code_file IN LISTS CODE_FILES)
        file(RELATIVE_PATH relative_path ${project_dir} ${code_file})
...
#Resources
function(CopyResourcesToBuild target_name source_dir)
    set(copy_target "copy_resources_${target_name}")
    message(${copy_target})
    file(GLOB_RECURSE RESOURCE_FILES CONFIGURE_DEPENDS ${source_dir}/resources/*)
    add_custom_target(${copy_target} ALL
        DEPENDS ${RESOURCE_FILES}
        COMMAND ${CMAKE_COMMAND} -E copy_directory ${source_dir}/resources ${CMAKE_BINARY_DIR}/resources)
