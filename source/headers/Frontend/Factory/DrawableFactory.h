...
public:
    ...
    static std::unique_ptr<Screen> CreateScreen(bool isHidden = false);

    static std::unique_ptr<RectDrawable> CreateRectDrawable(uint8_t layer, uint8_t order, Anchors&& anchors, ImVec2&& pivot,
    ...
    static std::unique_ptr<Rectangle> CreateRectangle(RectangleData&& rectangleData,
        bool isHidden = false);
    ...
    static std::unique_ptr<TextBox<Key, DisplayKey>> CreateDisplayTextBox(RectangleData&& rectangleData,
